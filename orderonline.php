...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__option">
            <ul>
                <li>USD <span class="arrow_carrot-down"></span></li>
                <li>ENG <span class="arrow_carrot-down"></span></li>
            </ul>
        </div>
    </div>
    <!-- Offcanvas Menu End -->
...
<div class="hero__slider owl-carousel">
            <div class="hero__item set-bg" data-setbg="img/hero/hero-6.jpg">
                <div class="container">
            ...
            <div class="hero__item set-bg" data-setbg="img/hero/hero-6.jpg">
                <div class="container">
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                                <h1>A shop specializing in making delicious bread</h1>
                        </div>
                    </div>
                </div>
            </div>
...
<a href="http://localhost/1/logout" class="btn btn-danger ml-3">Sign Out of Your Account</a>
        ...
        <div class="container">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="footer__widget">
                        <h6></h6>
                        <ul>
                            <li>English name:Kemp</li>
                            <li>Pinyin:Cheng Jiahao</li>
                            <li>Class:20IT1</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <p>Luca's Loaves wishes every user a good mood every day</p>
